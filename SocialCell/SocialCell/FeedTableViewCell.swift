...
class FeedTableViewCell: UITableViewCell {
    ...
    var feed: Feed! {
        didSet {
            ...
            contentTextLabel?.isHidden = feed.contents.text?.isEmpty == true
            contentImageView.isHidden = contentImageView.image == nil
            
            if let contentImageRatioConstrait = imageRatioConstraint {
                contentImageRatioConstrait.isActive = false
                contentImageView.removeConstraint(contentImageRatioConstrait)
            }
...
extension FeedTableViewCell {
    ...
    private func drawCell() {
        ...
        // let _ = ["좋아요", "댓글 달기", "공유하기"].forEach {}
        let _ = ["좋아요", "댓글 달기", "공유하기"].forEach { (title) in
        ...
        let contentStack = UIStackView(arrangedSubviews: [profileStack, contentTextLabel, contentImageView, buttonStack])
        ...
        let likeHeight = likesImageView.heightAnchor.constraint(lessThanOrEqualTo: likesLabel.heightAnchor)
        likeHeight.isActive = true
        likeHeight.priority = .defaultHigh
